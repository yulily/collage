...
<head>
	...
	<body class="create cf">
        ...
        <div id="siteHeader">
            ...
            <section class="cf" id="wrap">    
              ...
              <section id="tool" class="cf">
                      ...
                      <li>	
                          <dl>
                            ...
                            <dd id="palet">
                                ...
                                <ul class="cust cf">
                                  <li><input type="text" name="c2" value="#444444" size="6" id="t3"  class="html5jp-cpick [coloring:true]" /></li>
                                  <li><input type="text" name="c2" value="#444444" size="6" id="t4"  class="html5jp-cpick [coloring:true]" /></li>
                                  <li><input type="text" name="c2" value="#444444" size="6" id="t5"  class="html5jp-cpick [coloring:true]" /></li>
                                  <li><input type="text" name="c2" value="#444444" size="6" id="t6"  class="html5jp-cpick [coloring:true]" /></li>
                                  <li><input type="text" name="c2" value="#444444" size="6" id="t7"  class="html5jp-cpick [coloring:true]" /></li>
                                  <li><input type="text" name="c2" value="#444444" size="6" id="t8"  class="html5jp-cpick [coloring:true]" /></li>
                                  <li><input type="text" name="c2" value="#444444" size="6" id="t9"  class="html5jp-cpick [coloring:true]" /></li>
                                  <li><input type="text" name="c2" value="#444444" size="6" id="t10" class="html5jp-cpick [coloring:true]" /></li>
                                  <li><input type="text" name="c2" value="#444444" size="6" id="t11" class="html5jp-cpick [coloring:true]" /></li>
                                  <li><input type="text" name="c2" value="#444444" size="6" id="t12" class="html5jp-cpick [coloring:true]" /></li>
                                </ul>                    
                                </form>
                            </dd>
                  ...
                  <ul class="tool_01 cf">
                    ...
                    <li class="nf"><input type="text" name="c2" value="#000" size="12" id="t2" class="html5jp-cpick [coloring:true]" /></li>
                  </ul>
                  <ul class="tool_02 cf">
          ...
          <article>
              <header><h1>Your Canvas</h1></header>
              <ul id="canvas">
